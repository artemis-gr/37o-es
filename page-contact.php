...
// Map images
$map_img_raw = t37o_field('map_image', '');
$map_img_data = t37o_img_parts($map_img_raw);
$map_img = $map_img_data['src'] ?: get_stylesheet_directory_uri() . '/assets/img/map-placeholder.png';
...
// Studio fields
$studio_sectors_raw = t37o_field('studio_sectors', "Architecture\nInterior Design");
$studio_sectors = is_array($studio_sectors_raw)
  ? $studio_sectors_raw
  : preg_split('/\r\n|\r|\n/', (string)$studio_sectors_raw);

$studio_sectors = array_filter(array_map('trim', $studio_sectors));

$studio = [
  'name'     => t37o_field('studio_name', '37° Architecture Studio'),
  'location' => t37o_field('studio_location', 'Athens | Malaga'),
  'email'    => t37o_field('studio_email', 'info@37o.es'),
  'heading'  => t37o_field('studio_heading', 'Founders:'),
];
